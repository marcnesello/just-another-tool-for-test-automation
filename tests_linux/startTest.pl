...
#Create 4 commands
my $cmd1 = Command->new(1,"Show Directory","ls -l",$pos1,$neg1);
my $cmd2 = Command->new(2,"Show Version","uname",$pos2,$neg1);
my $cmd3 = Command->new(3,"Copy file", "cp testcopy.txt saft.txt",$pos4,$neg2);
my $cmd4 = Command->new(4,"Delete file", "rm -i saft.txt",$pos4,$neg1,$in);
my $cmd5 = Command->new(5,"Delete file", "rm -i saft.txt",$pos3,$neg1,$in);
my $cmd6 = Command->new(6,"Show Version","uname",$pos4,$neg2);
