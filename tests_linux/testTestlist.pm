...
sub testTestlist(){
	...
	my $pos42 = CheckList->new('Linux');
	my $pos43 = CheckList->new('insgesamt .+');
	...
	#Two new commands
	my $cmd42 = Command->new(42,"Just check version","uname",$pos42,$neg1);
	my $cmd43 = Command->new(43,"Just show dir","ls -l",$pos43,$neg1);
